...
public class Unmarshaller {
    ...
    public static FileClientCreateDirRespMessage unmarshallCreateDirRespo(byte[] msg) {
        ...
        FileClientCreateDirRespMessage response = new FileClientCreateDirRespMessage(operationCode, dirNameLen,
                dirName);
