...
public class Marshaller {
    ...
    public static byte[] marshal(FileClientWriteReqMessage msg) {
        ...
        // Combine all parts into a single byte array
        byte[] messageBytes = new byte[Integer.BYTES * 4 + filenameBytes.length + writeSequenceBytes.length];
    ...
    public static byte[] marshal(FileClientCreateFileReqMessage msg) {
        ...
        // Combine all parts into a single byte array
        byte[] messageBytes = new byte[Integer.BYTES * 3 + filenameBytes.length + contentBytes.length];
    ...
    public static byte[] marshal(FileClientDeleteFileReqMessage msg) {
        ...
        // Combine all parts into a single byte array
        byte[] messageBytes = new byte[Integer.BYTES * 2 + filenameBytes.length];
